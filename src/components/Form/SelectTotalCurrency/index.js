...
export const CURRENCY = [
  ...
  {img: 'bg-common-crypto-btc', symbol: 'USDC', desc: 'Bitcoin', rate: '1.00'},
...
function SelectTotalCurrency({isCrypto = false, id, className, label, selectedSymbol, onChange}) {
  ...
  const dropdown_list = _.map(CURRENCY, item=>{
    return (<div
      key={item.symbol}
      title={item.desc}
...
export default SelectTotalCurrency;