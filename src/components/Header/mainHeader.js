...
function LoginButton() {
  ...
  return (
    <Button
      ...
      onClick={handleClick}
    >
      <span className="font-semibold text-[10px] leading-[12px] mt-[2px] md:mt-0 md:text-[16px] md:leading-[24px] text-[#745FF2] dark:text-[#745FF2] transition-all duration-1000">
        {label}
      </span>
    </Button>
  );
    ...
    <div className="absolute top-0 left-[calc(50%-180px)] md:left-[calc(50%-450px)] w-[360px] md:w-[900px] z-50">
      ...
      {isTheme2 ? (
        <div className="relative w-full mt-[5px] md:mt-[20px] h-[50px] md:h-[74px] p-[6px] md:p-4 rounded-[14px] bg-[#E5E9ED] dark:bg-[#2A1B31] drop-shadow-[0_0px_7px_rgba(116,95,242,0.28)] border-2 dark:border-transparent">
          <span className="absolute left-[10px] top-[10px] md:left-[30px] md:top-[23px] font-semibold text-[14px] md:text-[24px] leading-[24px] tracking-[2px] text-transparent bg-clip-text bg-gradient-to-r from-[#745FF2] to-[#00DDA2]">
            {theme2Title}
          </span>
        </div>
      ) : (
      ...
      >
        {props.workflow.isLogged && !isTheme2 && (
          ...
          "
          >
            <span className="font-semibold text-[10px] leading-[12px] md:text-[16px] md:leading-[24px] text-transparent bg-clip-text bg-gradient-to-r from-[#745FF2] to-[#00DDA2] dark:from-[#F9D3B4] dark:to-[#F9D3B4] transition-all duration-1000">
              DEPOSIT
            </span>
          </button>
        )}
