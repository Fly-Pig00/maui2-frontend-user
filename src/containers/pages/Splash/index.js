  ...
  return (
    <div className='fixed w-full h-screen cursor-pointer' onClick={handleClick}>
      <div className='fixed w-full h-full flex flex-col justify-center items-center '>
        ...
        <div className='mt-[10px] md:mt-0 mb-20 font-semibold text-[18px] leading-[20px] tracking-[5px] md:text-[36px] md:leading-[54px] md:tracking-[10px] text-transparent bg-clip-text bg-gradient-to-r from-[#745FF2] to-[#00DDA2]'>BANKING REVOLUTION</div>
      </div>
      <div className='fixed left-[10%] bottom-[5%] md:left-[20%] md:bottom-[10%] text-center'>
        ...
        <div className='font-bold text-[#728AB7] dark:text-[#ffffff] tracking-[5px] text-[12px] md:text-sm transition-all duration-1000'>Defi Strategy</div>
      </div>
