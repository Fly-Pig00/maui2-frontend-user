...
function Deposit() {
  ...
  return (
    <div className='relative w-full min-h-[1050px] md:min-h-[1000px] bg-[#DEE2E8] dark:bg-[#32283C]'>
      ...
      <div className='bg-main-center dark:bg-main-center-dark pointer-events-none bg-center bg-cover absolute right-0 top-[230px] w-[150px] h-[123px] md:top-[200px] md:w-[550px] md:h-[450px] z-10'></div>
      {/* card */}
