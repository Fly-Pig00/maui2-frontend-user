...
function Borrow() {
  ...
  return (
    <div className='relative w-full min-h-[1610px] md:min-h-[1760px] bg-[#DEE2E8] dark:bg-[#32283C] transition-all duration-1000'>
      ...
      <span className='absolute top-[100px] w-full text-center block md:hidden font-semibold text-[40px] leading-[48px] tracking-[10px] text-transparent bg-clip-text bg-gradient-to-r from-[#00FF99] to-[#00DDA2]'>BORROW</span>
      {/* card */}
      <div className='absolute w-[350px] top-[160px] left-[calc(50%-175px)] md:w-[1020px] md:top-[230px] md:left-[calc(50%-510px)] bg-borrow-card dark:bg-borrow-card-dark shadow-borrow-card dark:shadow-borrow-card-dark border border-[#FFFFFF] rounded-[33px]'>
          ...
          <div className='text-[14px] md:text-[30px] text-center'>
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#00FF99] to-[#39C6D9]'>no repayments</span>
          ...
          <div className='relative mt-[20px] md:mt-[100px] w-full flex flex-col md:flex-row justify-center p-[20px]'>
            <div className='text-center w-full p-[40px]'>
              <div>
                <div className='text-left pl-[10px] text-[14px] md:text-[24px] text-[#000] dark:text-[#EFEFFA]'><span className='text-transparent bg-clip-text bg-gradient-to-r from-[#00FF99] to-[#39C6D9]'>Zero</span> Repayments</div>
              ...
              <div className='mt-[50px] md:mt-[100px]'>
                <div className='text-[16px] text-[#000] dark:text-[#EFEFFA] mb-[20px]'>Your yield <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#00FF99] to-[#39C6D9] text-[24px]'>Self Repays</span> your loan</div>
          ...
          <div className='mt-[60px] mb-[35px] md:mt-[120px] md:mb-[70px] text-center tracking-[4px]'>
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#00FF99] to-[#39C6D9]'>Deposit - Borrow -Zero Repayments</span>
          </div>
      </div>
    </div>
  )
