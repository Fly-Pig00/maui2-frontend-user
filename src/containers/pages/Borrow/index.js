...
function Borrow() {
  ...
  return (
    <div className='relative w-full min-h-[1670px] md:min-h-[1750px] bg-[#DEE2E8] dark:bg-[#32283C] transition-all duration-1000'>
      {/* bg images */}
      ...
      {/* card */}
      <div className='absolute w-[350px] top-[150px] left-[calc(50%-175px)] md:w-[1020px] md:top-[230px] md:left-[calc(50%-510px)] bg-borrow-card dark:bg-borrow-card-dark shadow-borrow-card dark:shadow-borrow-card-dark border border-[#FFFFFF] rounded-[33px]'>
          ...
          <div className='relative mt-[20px] md:mt-[100px] w-full flex flex-col md:flex-row justify-center p-[20px]'>
            <div className='text-center w-full p-[40px]'>
              <div>
                <div className='text-left pl-[10px] text-[14px] md:text-[24px] text-[#000] dark:text-[#EFEFFA]'><span className='text-transparent bg-clip-text bg-gradient-to-r from-[#745FF2] to-[#39C6D9]'>Zero</span> Repayments</div>
