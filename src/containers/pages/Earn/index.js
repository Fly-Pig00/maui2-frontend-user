...
function Earn(props) {
  ...
  return (
    <div className='relative w-full min-h-[1610px] md:min-h-[1270px] bg-[#DEE2E8] dark:bg-[#32283C]'>
      ...
      <span className='absolute top-[100px] w-full text-center block md:hidden font-semibold text-[40px] leading-[48px] tracking-[10px] text-transparent bg-clip-text bg-gradient-to-r from-[#00FF99] to-[#00DDA2]'>EARN</span>
      {/* card */}
          ...
          <div className='w-full md:w-[35%]'>
            <div className='mt-[20px] w-full bg-earn-right-panel dark:bg-earn-right-panel-dark border border-[#FFFFFF] dark:border-[#FFFFFF34] rounded-[20px] p-[20px]'>
              <div className='flex items-center justify-center'>
                ...
                <div className='w-[100px] ml-[20px] rounded-[14px] border border-[#728AB7] p-[2px] pl-[13px] pr-[10px] text-transparent bg-clip-text bg-gradient-to-r from-[#00FF99] to-[#00DDA2] text-[12px] md:text-[14px]'>{props.workflow.balance}</div>
              </div>
              <div className='flex items-center justify-center mt-[15px]'>
                <div className='text-[#707070] dark:text-[#F9D3B4] text-[12px] md:text-[14px]'>YIELD DEPOSIT USD</div>
                <div className='w-[100px] ml-[20px] rounded-[14px] border border-[#728AB7] p-[2px] pl-[13px] pr-[10px] text-transparent bg-clip-text bg-gradient-to-r from-[#00FF99] to-[#00DDA2] text-[12px] md:text-[14px]'>{depositedAmount}</div>
              </div>
            </div>
            <div className='mt-[30px] md:mt-[130px] text-center bg-deposit-card dark:bg-deposit-card-dark shadow-earn-panel dark:shadow-earn-panel-dark border border-[#FFFFFF30] dark:border-[#00FF9920] rounded-[26px] p-[25px]'>
              ...
              <div className='mt-[20px]'>
                <ImgVideoBanner
                  ...
                  description={
                    <div>
                      <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#00FF99] to-[#00DDA2]'>Earn</span> on your deposits. Withdraw anytime.
                    </div>
                  }
                />
              </div>
        ...
        <div className='w-full flex flex-col md:flex-row justify-between mt-[30px] mb-[10px]'>
          <div className='w-full md:w-[60%] flex md:flex-row-reverse'>
            <div className='w-full md:w-[80%]'>
              <div className='ml-[15px] text-[#273855] font-semibold dark:text-[#00FF99] text-[16px] md:text-[24px] transition-all duration-1000'>Your Expected Earnings</div>
