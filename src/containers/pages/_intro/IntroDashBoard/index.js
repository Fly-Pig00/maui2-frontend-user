      ...
      <div className="w-full pt-[20vh] md:pt-[20vh]">
        ...
        {!isMobile && (
          <div className="md:mt-[100px] mx-auto md:w-[70%] text-[#ffffffeb] md:text-center md:text-[20px] md:leading-[24px] md:font-[500]">
            ...
            . No risks of liquidation. You can repay with time if you prefer to
            pay zero repayments per month. Your collateral gets locked, and the
            yield generated pays off your loan. Simple. You have to reimagine
            the way you see finance. Maui brings you the future of people's new
            way of banking where everyone profits.
          </div>
        )}
        <div className="pt-[30px] md:pt-[35vh] md:pb-[20vh] md:w-full">
