      ...
      <div className="w-full pt-[20vh] md:pt-[20vh]">
        ...
        {!isMobile && (
          <div className="md:mt-[100px] mx-auto md:w-[70%] text-[#ffffffeb] md:text-center md:text-[20px] md:leading-[24px] md:font-[500]">
            ...
            instantly and not only you don't have to pay interest, but you get
            pay zero money per month. Your collateral gets locked, and the yield
            generated pays off your loan. You have to re imagine the way you see
            finance. Maui brings you the future of people's new way of banking
            where everyone os their own bank and profit from themselves.
          </div>
        )}
        ...
        <div className="flex flex-col-reverse md:flex-col">
          <div className="text-[#FFF] w-[90%] md:w-[75%] mt-[60px] mx-auto text-center text-[14px] md:text-[20px] md:leading-[24px] md:font-[500]">
            ...
            <span className="text-[#1199FA]">receive 8% per year</span> yield,
            that's a better return than most Hedge Funds and Superannuations
            across the globe.{" "}
            <span className="text-[#1199FA]">
