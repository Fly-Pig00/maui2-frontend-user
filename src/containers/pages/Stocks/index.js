...
function Stocks() {
  return (
    <div className='relative w-full min-h-[860px] md:min-h-[1500px] bg-[#DEE2E8] dark:bg-[#32283C] transition-all duration-1000'>
      {/* bg images */}
      ...
      {/* card */}
      <div className='absolute w-[350px] top-[150px] left-[calc(50%-175px)] md:w-[1020px] md:top-[230px] md:left-[calc(50%-510px)] bg-stocks-card dark:bg-stocks-card-dark shadow-stocks-card dark:shadow-stocks-card-dark border border-[#FFFFFF] rounded-[33px]'>
