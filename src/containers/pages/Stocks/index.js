...
function Stocks() {
  return (
    <div className='relative w-full min-h-[860px] md:min-h-[1500px] bg-[#DEE2E8] dark:bg-[#32283C] transition-all duration-1000'>
      ...
      <span className='absolute top-[100px] w-full text-center block md:hidden font-semibold text-[40px] leading-[48px] tracking-[10px] text-transparent bg-clip-text bg-gradient-to-r from-[#745FF2] to-[#00DDA2]'>STOCKS</span>
      {/* card */}
