...
function Stocks() {
  return (
    <div className='relative w-full min-h-[800px] md:min-h-[1500px] bg-[#DEE2E8] dark:bg-[#32283C] transition-all duration-1000'>
      {/* bg images */}
      ...
      {/* card */}
      <div className='absolute w-[350px] top-[110px] left-[calc(50%-175px)] md:w-[1020px] md:top-[230px] md:left-[calc(50%-510px)] bg-stocks-card dark:bg-stocks-card-dark shadow-stocks-card dark:shadow-stocks-card-dark border border-[#FFFFFF] rounded-[33px]'>
        <div className='mt-[20px] md:mt-[50px] text-center'>
          <span className='text-[18px] tracking-[5px] md:text-[35px] md:tracking-[10px] drop-shadow-[0_0px_4px_rgba(162,89,255,0.67)] text-transparent bg-clip-text bg-gradient-to-r from-[#745FF2] to-[#39C6D9]'>Synthetic Stocks</span>
        </div>
        ...
        <div className='mt-[20px] mb-[30px] text-[14px] md:text-[24px] font-semibold text-center tracking-[2px]'>
          ...
          <br />
          <span className='text-[14px] md:text-[18px] tracking-[5px] text-transparent bg-clip-text bg-gradient-to-r from-[#745FF2] to-[#39C6D9]'>Delta neutral</span>
        </div>
      </div>
    </div>
  )
