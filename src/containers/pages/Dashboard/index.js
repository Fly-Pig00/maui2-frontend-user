...
function Main(props) {
  ...
  return (
    <div className='relative w-full min-h-[1200px] pt-[170px] pb-[110px] md:pb-[40px] md:pt-0 bg-main-background dark:bg-main-background-dark bg-center bg-cover transition-all duration-1000'>
      ...
      <span className='absolute top-[100px] w-full text-center block md:hidden font-semibold text-[40px] leading-[48px] tracking-[10px] text-transparent bg-clip-text bg-gradient-to-r from-[#00FF99] to-[#00DDA2]'>Dashboard</span>
      <Card
        id='main-card-earn'
        url='/earn'
        ...
        btnTitle="Earn"
        description={<div><span className='text-transparent bg-clip-text bg-gradient-to-r from-[#00FF99] to-[#00DDA2]'>Earn</span> on your deposits. Withdraw anytime.</div>}
      />
      <Card
        id='main-card-borrow'
        url='/borrow'
        ...
        btnTitle="Borrow"
        description={<div><span className='text-transparent bg-clip-text bg-gradient-to-r from-[#00FF99] to-[#00DDA2]'>Borrow</span> up to <span className='text-[#00DDA2]'>50%</span> of your collateral. No repayments. Your yield pays off your loan!</div>}
      />
      <Card
        id='main-card-cards'
        url='/cards'
        ...
        title2="Mastercards"
        btnTitle="Cards"
        description={<div><p>Crypto or Fiat, for choice.</p><br /><p>Connect to your cards & enjoy your <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#00FF99] to-[#00DDA2]'>MAUI</span> Benefits</p></div>}
      />
      <Card
        id='main-card-stocks'
        url='/stocks'
        ...
        btnTitle="Stocks"
        description={<div><span className='text-transparent bg-clip-text bg-gradient-to-r from-[#00FF99] to-[#00DDA2]'>Delta Neutral</span><br/>Strategy with one click.</div>}
      />
    </div>
  )
}
