...
function Card({id, className, img, title1, title2, description, btnTitle}) {
  return (
    <div id={id} className={`w-[340px] bg-main-card dark:bg-main-card-dark absolute rounded-[26px] border border-[#FFFFFF68] shadow-main-card dark:shadow-main-card-dark p-[24px] ${className}`}>
      ...
      <div className='mt-[20px] w-full'>
        <button className='bg-main-card-btn shadow-main-card-btn rounded-[16px] text-[20px] text-[#F0F5F9] tracking-[3px] p-2 w-full'>{btnTitle}</button>
      </div>
    </div>
  )
}
...
function Main(props) {
  ...
  return (
    <div className='relative bg-main-background dark:bg-main-background-dark bg-center bg-cover w-full min-h-[1200px] transition-all duration-1000' onClick={handleClick}>
      ...
      <div id='main-center' className='bg-main-center dark:bg-main-center-dark bg-center bg-cover absolute left-[calc(50%-280px)] top-[calc(50%-170px)]  w-[550px] h-[450px] z-10'></div>
      <Card
        id='main-card-earn'
