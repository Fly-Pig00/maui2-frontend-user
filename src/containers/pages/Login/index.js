  ...
  return (
    <div className='relative w-full min-h-[900px] md:min-h-[1000px] bg-login-background dark:bg-login-background-dark transition-all duration-1000'>
      ...
      <div className='absolute w-[320px] h-[650px] left-[calc(50%-160px)] top-[90px] md:w-[900px] md:h-[750px] md:top-[calc(50%-430px)] md:left-[calc(50%-450px)] bg-[#5882C140] dark:bg-[#FFFFFF1A] backdrop-blur-[25px] border-[3px] border-[#5882C1] dark:border-[#FFFFFFB0] rounded-[40px] p-[20px] text-center'>
        ...
        <TerraConnect
          className="mt-[15px] md:mt-[30px] rounded-[25px] md:rounded-[50px] border-2 border-[#0C3E9F] dark:border-[#745FF2] w-[60%] h-[50px] bg-[#FFFFFF] dark:bg-[#4D4360]"
          label={<span className='font-semibold text-[14px] leading-[16px] md:text-[20px] md:leading-[24px] tracking-[1px] text-[#0C3E9F] dark:text-[#745FF2] transition-all duration-1000'>My Account</span>}
        />
        ...
        <TerraConnect
          className="mt-[15px] md:mt-[30px] rounded-[25px] md:rounded-[50px] border-2 border-[#003465] dark:border-[#745FF2] w-[60%] h-[50px] bg-[#003465] dark:bg-[#745FF2]"
