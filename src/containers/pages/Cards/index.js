...
function Cards() {
  return (
    <div className='relative w-full min-h-[980px] md:min-h-[1700px] bg-[#DEE2E8] dark:bg-[#32283C] transition-all duration-1000'>
      ...
      {/* card */}
      <div className='absolute w-[320px] top-[150px] left-[calc(50%-160px)] md:w-[1020px] md:top-[230px] md:left-[calc(50%-510px)] bg-borrow-card dark:bg-borrow-card-dark shadow-borrow-card dark:shadow-borrow-card-dark border border-[#FFFFFF] rounded-[33px] p-[20px] md:p-[40px]'>
